...
namespace FileHash.Model
{
    ...
    /// </summary>
    public class FileHashParallel : IDisposable
    {
        /// <summary>
        /// 获取允许计算的散列值的类型数量
        /// </summary>
        ...
        /// 计算完成时发生。
        /// </summary>
        public event EventHandler<NullableResultEventArgs<FileHashParallel>> Completed;
        ...
        private void Compute()
        {
            ...
            while (this.fileHashComputeThreads.Any(fileHashComputeThread => fileHashComputeThread.IsAlive))
            {
                ...
                if (this.fileHashComputeBackgroundWorker.CancellationPending)
                {
                    ...
                    this.OnCompleted(this, new NullableResultEventArgs<FileHashParallel>());
                    return;
                }
                Thread.Sleep(10);
            }
            ...
            this.IsCompleted = true;
            this.OnCompleted(this, new NullableResultEventArgs<FileHashParallel>(this));
