...
namespace FileHash.Model
{
    ...
    /// 计算文件信息和散列的线程队列类
    /// </summary>
    public class FileInfoAndHashList : Collection<FileInfoAndHash>
    {
        /// <summary>
        ...
        /// </summary>
        public event EventHandler<NullableResultEventArgs<FileInfoAndHash>> CurrentCompleted;

        /// <summary>
        /// 队列计算完成事件，全部文件散列计算完成时发生。
        /// </summary>
        public event EventHandler<NullableResultEventArgs<FileInfoAndHashList>> ListCompleted;
        ...
        /// <param name="e"></param>
        protected virtual void OnCurrentCompleted(
        ...
        private void CheckListCompleted()
        {
            ...
            {
                this.OnListCompleted(this, new NullableResultEventArgs<FileInfoAndHashList>());
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FileInfoAndHash_Completed(
            object sender, NullableResultEventArgs<FileInfoAndHash> e)
        {
